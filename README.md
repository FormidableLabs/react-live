...
|language|PropTypes.string|What language you're writing for correct syntax highlighting. (Default: `jsx`). Note: From 3.1.0 and onwards, typescript is supported when the values `typescript` or `tsx` are used. 
